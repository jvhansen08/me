import profilePic from "../assets/me-off-center2.jpg"
...
export function Home() {
    ...
    return(
        <div className="about-container" style={{textAlign: "initial"}}>
            <img src={profilePic} alt="A close-up image of a young man wearing a blue Utah State shirt" style={{width: "100%"}} />
